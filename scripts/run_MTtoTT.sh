...
DATAPATH="/lustre/SCRATCH/atlas/ywng/optimization_bkgnd/selectionlaserntuple"
...
mkdir $OUTDIR
mkdir ${OUTDIR}/TT_Signal_ISRjet_30
mkdir ${OUTDIR}/TT_Signal_ISRjet_40
mkdir ${OUTDIR}/TT_Signal_ISRjet_50
mkdir ${OUTDIR}/TT_Signal_ISRjet_80
mkdir ${OUTDIR}/TT_Signal_ISRjet_100
mkdir ${OUTDIR}/TT_Signal_ISRjet_130
mkdir ${OUTDIR}/TT_Signal_ISRjet_160
mkdir ${OUTDIR}/TT_Signal_ISRjet_190
mkdir ${OUTDIR}/TT_Signal_ISRjet_220
...
#xAH_run.py --config dijetISR/scripts/config_MTtoTT.py --vfiles ${DATAPATH}/JZ2.root               --treeName MiniTree --submitDir ${OUTDIR}/TT_JZ2               --force --isMC direct &
...
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_30.root  --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_30  --force --isMC direct &
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_40.root  --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_40  --force --isMC direct &
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_50.root  --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_50  --force --isMC direct &
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_60.root  --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_60  --force --isMC direct &
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_80.root  --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_80  --force --isMC direct &
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_100.root --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_100 --force --isMC direct &
xAH_run.py --config ../scripts/config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_130.root --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_130 --force --isMC direct &
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_160.root --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_160 --force --isMC direct &
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_190.root --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_190 --force --isMC direct &
xAH_run.py --config config_MTtoTT.py --files ${DATAPATH}/Signal_ISRjet_220.root --treeName MiniTree --submitDir ${OUTDIR}/TT_Signal_ISRjet_220 --force --isMC direct &
